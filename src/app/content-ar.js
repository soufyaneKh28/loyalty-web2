...
const data = {
  ...
  form: {
    ...
    ServiceTypeOptions: [
      {
        value: "التسويق عبر وسائل التواصل الاجتماعي",
        label: "التسويق عبر وسائل التواصل الاجتماعي",
      },
      { value: "تسويق المحتوى", label: "تسويق المحتوى" },
      { value: "التسويق الرقمي", label: "التسويق الرقمي" },
      { value: "الصفحات المقصودة", label: "الصفحات المقصودة" },
      { value: "الشعار والهوية البصرية", label: "الشعار والهوية البصرية" },
      { value: "تطبيقات الهاتف المحمول", label: "تطبيقات الهاتف المحمول" },
      { value: "خدمات الإنتاج", label: "خدمات الإنتاج" },
      {
        value: "تحسين محركات البحث",
        label: "تحسين محركات البحث",
      },
      { value: "المواقع الإلكترونية", label: "المواقع الإلكترونية" },
